...
class VegaViewResolverFactory extends ViewResolverFactory {
	...
	static {
		...
		viewResolversMap.put(VegaCommand.Report.VIEW_DETAILS, VrReportViewDetails.class);
		...
		viewResolversMap.put(VegaCommand.User.GET_ALL, VrUsersGetAll.class);
		viewResolversMap.put(VegaCommand.User.EDIT, VrUsersEdit.class);
		viewResolversMap.put(VegaCommand.User.EXECUTE_EDIT, VrUsersRedirect2GetAll.class);
		viewResolversMap.put(VegaCommand.User.CREATE, VrUsersCreate.class);
		viewResolversMap.put(VegaCommand.User.EXECUTE_CREATE, VrUsersRedirect2GetAll.class);
		viewResolversMap.put(VegaCommand.User.DELETE, VrUsersDelete.class);
		viewResolversMap.put(VegaCommand.User.EXECUTE_DELETE, VrUsersRedirect2GetAll.class);
	}
